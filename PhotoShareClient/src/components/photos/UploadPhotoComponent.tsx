...
const UploadPhotoComponent: React.FC<UploadPhotoComponentProps> = ({ open, onClose }) => {
  ...
  const userId = useSelector((state: { user: { id: number } }) => state.user.id) // Moved hook call to top level
      ...
      if (uploadResponse.meta.requestStatus === "fulfilled") {
        ...
        if (downloadResponse.meta.requestStatus === "fulfilled") {
          ...
          const photoData = {
            ...
            name: fileName,
            tags: photoTags,
            userId: userId, // Updated to use userId from top level hook
            countViews: 0,
          }
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Box sx={{ display: "flex", alignItems: "center" }}>
            <CloudUpload sx={{ mr: 1.5, color: theme === "dark" ? "#00c6ff" : "#3b82f6" }} />
            <Typography variant="h6">Upload Photo</Typography>
          </Box>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column" }}>
            <Grid container spacing={3}>
              <Grid size={{ xs:12, md:6}}>
                ...
                >
                  ...
                  {previewUrl ? (
                    ...
                    <Box sx={{ textAlign: "center" }}>
                      ...
                      />
                      <Typography variant="h6" sx={{ color: theme === "dark" ? "white" : "#1e293b", mb: 1 }}>
                        Drag & Drop Photo
                      </Typography>
                      <Typography
                        variant="body2"
                ...
                {loading && (
                  <Box sx={{ mt: 2, width: "100%" }}>
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          background:
                            theme === "dark"
                              ? "linear-gradient(90deg, #00c6ff, #0072ff, #7209b7)"
                              : "linear-gradient(90deg, #3b82f6, #1d4ed8, #8b5cf6)",
                          borderRadius: 4,
                          transition: "width 0.3s ease",
                        }}
                      />
                    ...
                    <Typography
                      variant="body2"
                      sx={{ color: theme === "dark" ? "white" : "#1e293b", mt: 1, textAlign: "center" }}
                    >
                      {uploadProgress < 100 ? `Uploading... ${uploadProgress}%` : "Processing..."}
                    </Typography>
                  </Box>
              ...
              <Grid size={{ xs:12, md:6}}>
                ...
                >
                  <Label sx={{ mr: 1, color: theme === "dark" ? "#00c6ff" : "#3b82f6" }} />
                  Add Tags
                </Typography>
