...
// // // const AppLayout = () => {
// // //     return (
// // //         <div style={{ backgroundColor: '#1a1f36', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
// // //             <AppBar position="static" sx={{ background: 'linear-gradient(90deg, #1a1f36, #3a4276, #8a2be2)' }}>
// // //                 <Toolbar sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
// // //                     <Box sx={{ display: 'flex', alignItems: 'center' }}>
// // //                         <img src={logo} alt="PhotoShare Logo" style={{ height: '50px', marginRight: '10px' }} />
// // //                     </Box>
// // //                     <Typography variant="subtitle1" sx={{ color: '#d1d1e0' }}>
...
// // //             <AppBar position="static" sx={{ top: 'auto', bottom: 0, background: 'linear-gradient(90deg, #1a1f36, #3a4276)' }}>
// // //                 <Toolbar sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
...
// // import { AppBar, Toolbar, Typography, Box } from '@mui/material';
// // import { Outlet } from 'react-router-dom';
// // import logo from '../assets/logo2.png'; // המיקום של התמונה שלך
