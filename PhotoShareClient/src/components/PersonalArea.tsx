...
import { useState } from 'react';
import { Box, Button, Typography } from '@mui/material';
import AlbumList from './AlbumOverview';
import AddAlbum from './AddAlbum';
import Sidebar from './Sidebar';
import EmojiEmotionsIcon from '@mui/icons-material/EmojiEmotions';
import UploadPhotoComponent from './UploadPhotoComponent';
...
import MenuIcon from '@mui/icons-material/Menu';
import CloseIcon from '@mui/icons-material/Close';
import PhotoGallery from './PhotoGallery'; // Import the PhotoGallery component
    ...
    return (
        <Box>
            ...
            <Grid container spacing={isSidebarOpen ? 2 : 1}>
                ...
                <Grid item xs={12} md={9}>
                    <AlbumList onSelectAlbum={setSelectedAlbumId} /> {/* Pass the function to set selected album ID */}
